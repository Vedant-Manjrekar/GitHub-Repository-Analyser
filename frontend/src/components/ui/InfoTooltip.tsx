      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              "absolute z-50 top-full mt-2 w-80 sm:w-96 bg-surface-1 border border-border-strong rounded-2xl shadow-floating overflow-hidden text-left pointer-events-auto",
              alignClasses[align]
            )}
            onMouseEnter={() => setIsOpen(true)}
            onMouseLeave={() => setIsOpen(false)}
